  ...
  function nt(t, n, e, i, o) {
    ...
    return 0 === n
      ...
      : (l || (l = o * (0.3 * 1.5)),
        u < ht(i) ? ((u = i), (r = l / 4)) : (r = (l / (2 * dt)) * pt(i / u)),
        n < 1
          ? -0.5 * (u * ct(2, 10 * (n -= 1)) * st(((n * o - r) * (2 * dt)) / l)) + e
          : u * ct(2, -10 * (n -= 1)) * st(((n * o - r) * (2 * dt)) / l) * 0.5 + i + e);
  }
    ...
    Wt = (function () {
      function t() {
        var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          e =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 'body, html';
        mt(this, t),
          (this.isSSR = !Ot),
        ...
        kt(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              this.isSSR ||
                (this.container
                  ? (this._stopScrollListener && (this._shouldCallCancelScroll = !0),
                    this.tween.stop(t))
          ...
          },
          {
            ...
            value: function (t, n) {
              !this.isSSR &&
                It &&
                n &&
                _t.history['replace' === n ? 'replaceState' : 'pushState'](null, null, t);
            },
          },
          {
            key: 'getContainer',
          ...
          },
          {
            ...
            value: function () {
              ...
              t &&
                ...
                (A(t, Qt, this._stopScrollListener), (this._stopScrollListener = null));
            },
          },
          {
            key: 'hook',
            value: function (t, n) {
              for (
                var e = t[n], o = arguments.length, r = Array(o > 2 ? o - 2 : 0), l = 2;
                l < o;
                l++
              )
                r[l - 2] = arguments[l];
